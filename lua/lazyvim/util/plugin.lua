...
M.deprecated_extras = {
  ...
  Either use `basedpyright`, or copy the [old extra](https://github.com/NewbieAndy/LazyVim/blob/c1f5fcf9c7ed2659c9d5ac41b3bb8a93e0a3c6a0/lua/lazyvim/plugins/extras/lang/python-semshi.lua#L1) to your own config.
  ]],
}
